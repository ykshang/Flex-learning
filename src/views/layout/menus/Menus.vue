...
<div style="position:'relative';">
  <div class="menuHeader">
      ...
      <el-button v-else icon="fa fa-chevron-left fa-lg"  type="text" style="float: right;" @click="changeCollapse"></el-button>
  </div>
  <el-menu class="el-menu-vertical-demo" :collapse="isCollapse" @select="onSelect" background-color="#f2f6fc">
